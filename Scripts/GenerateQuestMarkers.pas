...
begin
  ...
  if TAG_STYLE = 'compact' then begin
    ...
    slTags.Values['timed_radiant']            := '[T]';
    slTags.Values['timed']                    := '[T]';
    slTags.Values['settlement_defense']       := '[D]';
    slTags.Values['defend']                   := '[D]';
    ...
    slTags.Values['timed_radiant']            := '[Timed]';
    slTags.Values['timed']                    := '[Timed]';
    slTags.Values['settlement_defense']       := '[Defend]';
    slTags.Values['defend']                   := '[Defend]';
    slTags.Values['nextgen']                  := '[CC]';
    slTags.Values['cc']                       := '[CC]';
  end;
